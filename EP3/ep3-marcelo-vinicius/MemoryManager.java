            ...
            if (line[0].equals("carrega"))
                ...
                switch (alg) {
                    case 1:
                        ...
                        break;
                    case 2:
                        System.out.println("Gerenciamento de espaço livre: Worst Fit.");
                        FSM = new WorstFit(s, virt);
                        break;
                    case 3:
                        System.out.println("Gerenciamento de espaço livre: Quick Fit.");
                ...
                switch (alg) {
                    case 1:
                        System.out.println("Algoritmo de paginacao: Optimal.");
                        PM = new Optimal(virt, p, total, events);
                        break;
                    case 2:
                        System.out.println("Algoritmo de paginacao: FIFO.");
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        System.out.println("Algoritmo de paginacao: LRU (4a versao).");
                ...
                for (Event e : events) {
                    ...
                    // Chegada de processo na memória virt
                    if (typeEvent == 0) {
